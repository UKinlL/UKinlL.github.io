...
var aLi = oSlidleft.getElementsByTagName('a')
aLi[0].setAttribute('gao',1800)
aLi[1].setAttribute('gao',2500)
aLi[2].setAttribute('gao',3100)
aLi[3].setAttribute('gao',3600)
aLi[4].setAttribute('gao',4200)
aLi[5].setAttribute('gao',4800)
aLi[6].setAttribute('gao',0)



for(let i=0;i<aLi.length;i++){
    aLi[i].addEventListener('click',scroTo,false)
}
...
function scroTo(ev){
    var ev = ev || event
    console.log(ev)
    console.log(ev.target.attributes.gao.value)
    var height = ev.target.attributes.gao.value
    if(document.body.scrollTop < height){
        var timerScro = setInterval(function(){
            var hei = document.body.scrollTop;
                scrollTo(0,hei+15)
                if(hei > height){
                    console.log('到达')
                    clearInterval(timerScro);
                }
        },1)
    }
    if(document.body.scrollTop > height){
